    ...
    try {
        ...
        if (feedbackContainer) {
            ...
            if (secondaryAvg < 30) {
                ...
                recEl.innerHTML = '<strong>Совет:</strong> Вы в отличной форме! Периодически заходите в <a href="training">тренажер</a> просто для удовольствия, чтобы поддерживать этот высокий уровень.';
                ...
                recEl.innerHTML = '<strong>Совет:</strong> Чтобы навык не угасал со временем, попробуйте иногда проходить <a href="training">тренажёры</a> и решать по 1-2 таблицы Шульте в свободную минуту. Это поможет держать мозг в тонусе без лишних усилий.';
                ...
                recEl.innerHTML = '<strong>Совет:</strong> Ингибиторный контроль работает как мышца. Попробуйте уделить <a href="training">тренировкам</a> 10 минут пару раз в неделю, и вы очень быстро заметите, как время выполнения тестов начнет сокращаться.';
            }
        }
        // ------------------------------------------
